...
public class HuntBehaviour implements Behaviour {
	...
	/**
	 * Gets the action to be generated.
	 * If the actor is a Zombie and the zombie has only 1 leg, then it can only hunt targets every second turn.
	 *
	 * @see Action#execute(Actor, GameMap)
	 * @param actor The actor performing the action.
	 * @param map The map the actor is on.
	 * @return an Action that hunts a target
	 */
	@Override
